function [ state_history,time_history,iteration_history ] = simulate_demo_trailer_panoc_draft( trailer_controller, simulator, ...
...
%   Detailed explanation goes here
    ...
    for i=1:number_of_steps
        ...
        disp(['The optimal input is[' num2str(optimal_input(1)) ' ; ' num2str(optimal_input(2)) '] in ' num2str(iteration_history(i)) ' iterations']);

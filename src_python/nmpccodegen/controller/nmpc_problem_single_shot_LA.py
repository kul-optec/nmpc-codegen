...
class Single_shot_LA_definition:
    ...
    def generate_cost_function(self):
        ...
        lambdas = cd.SX.sym('lambdas', self.controller.number_of_general_constraints * self.controller.horizon, 1);
        general_constraint_weights = cd.SX.sym('general_constraint_weights',self.controller.number_of_general_constraints * self.controller.horizon,1);

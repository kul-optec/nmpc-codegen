classdef Nmpc_panoc
    ...
    properties
        ...
        obstacles=[] % Contains the obstacles, add new obstacles with the add_obstacle method.
        number_of_obstacles=0 % Contains a number of obstacles.
        general_constraints=[] % Contains a general constraints add new constraints with the add_general_constraint method
        shift_input=false % If true, the input horizon will be shifted after returning the optimal input
        ...
        % from here on variables only used with lagrangian
    ...
    methods(Access =  public)
        ...
        function obj = add_obstacle(obj,obstacle)
            % Add an obstacle to the controller.

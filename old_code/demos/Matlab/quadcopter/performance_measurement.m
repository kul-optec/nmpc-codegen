clear all;
% close all;
noise_amplitude=[ones(3,1)*0.;zeros(9,1)];
...
figure(1);clf;
plot3(state_history(1,:),state_history(2,:),state_history(3,:),'k');hold all;
...
semilogy(time_history_panoc_draft,'kx');

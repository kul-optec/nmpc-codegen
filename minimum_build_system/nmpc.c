...
int npmc_solve( const real_t* current_state,
    ...
    for (i_panoc= 0; i_panoc < 100 ; i_panoc++)
    {
        ...
        printf("i=%d current cost=%f change=%f residual=%f tau=%f inf_norm=%f signed_inf_norm=%f \n",\
            i_panoc,current_f,current_f-previous_f,residual,panoc_get_tau(),inf_norm_difference,\
